      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-5">
        ...
        <section className="rounded-3xl bg-white p-5 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <h2 className="text-2xl font-black">Эхний лайваа эхлүүлэх checklist</h2>
            <p className="rounded-full bg-emerald-50 px-4 py-2 text-sm font-bold text-emerald-700">Тохиргоо: 3/5 бэлэн (demo явц)</p>
          </div>
          <p className="mt-2 text-slate-700">Нэг удаа тохируулаад, дараагийн лайв бүрээ Borlo-р цэгцлээрэй.</p>
          <div className="mt-4 grid gap-3">
            {[
              ...
              <div key={item[0]} className="rounded-2xl border bg-slate-50 p-4">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <button className="rounded-xl bg-slate-950 px-3 py-2 text-sm font-bold text-white">Facebook Page холбох</button>
            <button className="rounded-xl bg-slate-100 px-3 py-2 text-sm font-bold">Gmail мэдэгдэл тохируулах</button>
            <a href="#products" className="rounded-xl bg-slate-100 px-3 py-2 text-sm font-bold">Бараа нэмэх</a>
            <button className="rounded-xl bg-slate-100 px-3 py-2 text-sm font-bold">Active Live хайх</button>
            <button onClick={() => setLiveFinished(true)} className="rounded-xl bg-emerald-600 px-3 py-2 text-sm font-bold text-white">Лайв дуусгах</button>
          </div>
          <p className="mt-3 text-xs text-slate-500">Хялбар эхлэхэд зориулсан demo checklist: нэг удаа тохируулах, бэлэн болгох, шалгах, заавар үзэх.</p>
        </section>

        <section className="rounded-3xl bg-white p-5 shadow-sm">
          <h3 className="text-xl font-black">Тохиргоо хийхэд тусламж хэрэгтэй юу?</h3>
          <p className="mt-2 text-slate-700">Facebook Page болон Gmail орлогын мэдээний тохиргоог нэг удаа хийвэл дараагийн лайв бүр дээр Borlo таны сэтгэгдэл, төлбөр, үлдэгдэл, баглаа боодлыг цэгцэлнэ.</p>
          <div className="mt-4 flex flex-wrap gap-2">
            <button className="rounded-xl bg-slate-100 px-3 py-2 text-sm font-bold">Facebook Page заавар</button>
            <button className="rounded-xl bg-slate-100 px-3 py-2 text-sm font-bold">Gmail мэдэгдлийн заавар</button>
            <button className="rounded-xl bg-amber-300 px-3 py-2 text-sm font-bold text-slate-900">Тест live эхлүүлэх</button>
          </div>
        </section>
